...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="home.php" class="logo">Loja<span>Virtual</span></a>
      ...
      <div class="profile">
         ...
         <a href="update_user.php" class="btn">Alterar perfil</a>
         <div class="flex-btn">
            <a href="user_register.php" class="option-btn">cadastrar</a>
