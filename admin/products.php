...
if(isset($_POST['add_product'])){
   ...
   if($select_products->rowCount() > 0){
      $message[] = 'O nome desse produto já existe na lista';
   }else{
...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      <div class="flex">
         ...
         <div class="inputBox">
            <span>valor do produto (obrigatório)</span>
            <input type="number" min="0" class="box" required max="9999999999" placeholder="digite o valo do produto" onkeypress="if(this.value.length == 10) return false;" name="price">
         </div>
        <div class="inputBox">
        ...
        <div class="inputBox">
         ...
         <div class="inputBox">
            <span>informações do produto (obrigatório)</span>
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         ...
         <a href="products.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('deletar esse produto?');">delete</a>
      </div>
   </div>
   <?php
         }
      }else{
         echo '<p class="empty">nenhum produto cadastrado!</p>';
      }
   ?>
